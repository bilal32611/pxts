...
//-Do not confuse the startValue of filter with baseValue of AniProp. The base value here is IF  THERE IS NO FILTER ATTACHED. if there is a filter then we use filters value.
private baseValue :T;  
